package nl.bumastemra.portal.features.shared.layouts
...
class BaseLayout : Layout {
    ...
    override fun render(): HTMLView = {
        head {
            ...
            this@BaseLayout.head(this)
        }
        body {
            this@BaseLayout.body(this)
        }
    }
